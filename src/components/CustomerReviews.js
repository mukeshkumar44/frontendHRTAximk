      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
            ...
            <div className="flex items-center">
              <div className="w-12 h-12 bg-gray-300 rounded-full overflow-hidden mr-4">
                <img src="/avatar1.jpg" alt="Aarav Singh" className="w-full h-full object-cover" />
              </div>
              <div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
            ...
            <div className="flex items-center">
              <div className="w-12 h-12 bg-gray-300 rounded-full overflow-hidden mr-4">
                <img src="/avatar2.jpg" alt="Riya Mehta" className="w-full h-full object-cover" />
              </div>
              <div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
            ...
            <div className="flex items-center">
              <div className="w-12 h-12 bg-gray-300 rounded-full overflow-hidden mr-4">
                <img src="/avatar3.jpg" alt="Vikram Patel" className="w-full h-full object-cover" />
              </div>
              <div>
