  ...
  return (
    <div className="relative">
      ...
      <div className="relative h-[700px] overflow-hidden">
        ...
        <video src="https://videos.pexels.com/video-files/5834567/5834567-uhd_2160_3840_24fps.mp4" autoplay muted="" loop="" playsinline="" class="block-background__image" poster="https://images.pexels.com/videos/5834567/pexels-photo-5834567.jpeg?auto=compress&amp;cs=tinysrgb&amp;fit=crop&amp;h=800&amp;w=1700"></video>
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-white text-center px-4">
          <h1 className="text-5xl md:text-6xl font-bold mb-6">Your Trusted Travel Partner</h1>
          <p className="text-xl mb-10 max-w-2xl">Experience comfortable and reliable taxi services across India</p>
          <div className="flex flex-col sm:flex-row gap-4">
            <button 
              onClick={handleBookNow} 
              className="bg-yellow-500 text-black px-8 py-3 rounded-full font-semibold hover:bg-yellow-400 transition duration-300"
            >
              Book a Taxi
            </button>
            <button className="bg-transparent border-2 border-white text-white px-8 py-3 rounded-full font-semibold hover:bg-white/10 transition duration-300">Explore Tours</button>
          </div>
        </div>
      </div>
